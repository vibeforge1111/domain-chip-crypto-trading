...
- active benchmark candidate count: `25`
- current top benchmark candidate: `auto-breakout-impulse-squeeze-compression_profile=tight_squeeze-session_profile=squeeze_release_window`
