...
- holdout_profitability_score: `0.4415`
...
- primary_mechanism: Backtested on 158 active BTC 15m contract decisions across 21791 covered windows.
...
- promotion_candidate_kind: `benchmark_grounded_boundary`
- eligibility_status: `eligible_for_boundary_promotion`
- primary_mechanism: Backtested on 23 active BTC 1h contract decisions across 5447 covered windows. Fallback used because requested timeframe `4h` unavailable.
- primary_boundary: Insufficient heavy-backtest breadth or unstable returns still block promotion.

## btc-15m-volatility-compression-breakout-psychology_no_chase-variety-session-stability-filter-variety-executio-7252eb8740
...
- promotion_candidate_kind: `benchmark_grounded_boundary`
- eligibility_status: `eligible_for_boundary_promotion`
- primary_mechanism: Backtested on 21 active BTC 15m contract decisions across 21791 covered windows.
- primary_boundary: Insufficient heavy-backtest breadth or unstable returns still block promotion.
...
- promotion_candidate_kind: `benchmark_grounded_boundary`
- eligibility_status: `eligible_for_boundary_promotion`
- primary_mechanism: Backtested on 0 active BTC 15m contract decisions across 21695 covered windows.
- primary_boundary: Insufficient heavy-backtest breadth or unstable returns still block promotion.
