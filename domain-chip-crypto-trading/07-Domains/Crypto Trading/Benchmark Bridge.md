...
- primary_mechanism: Backtested on 48 active BTC 1h contract decisions across 5447 covered windows. Fallback used because requested timeframe `4h` unavailable.
- primary_boundary: Insufficient heavy-backtest breadth or unstable returns still block promotion.
...
## auto-auto-breakout-impulse-squeeze-compression_profile=moderate_squeeze-late_sample_guard=on-sparse_signal-ps-cec7d46bc1
...
## auto-baseline-sparse_signal-probe-sparse_signal-variety-late-sample-guard-plus-session-filter
...
## btc-15m-volatility-compression-breakout-psychology_no_chase-probe-sparse_signal
