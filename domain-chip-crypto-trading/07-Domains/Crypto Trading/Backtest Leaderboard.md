...
- trend: trades=`21` win_rate=`0.5238` avg_return=`0.0076`
...
- base: trades=`21` profitability=`0.5038` avg_return=`0.0076` gate=`False`
- elevated_fees: trades=`21` profitability=`0.4838` avg_return=`-0.0324` gate=`False`
- fee_and_slippage: trades=`21` profitability=`0.4638` avg_return=`-0.0724` gate=`False`
